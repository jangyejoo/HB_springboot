...
public class RedisUtil {
    ...
    public void setBlackList(String key, Object o, int minutes) {
        ...
        System.out.println("setBlacklist : "+getBlackList(key).toString());
    }
   
    /*
   
    public void setBlackList(String key, int minutes) {
    	redisBlackListTemplate.opsForValue().set(key, true);
    	redisBlackListTemplate.expire(key,  minutes, TimeUnit.MINUTES);
